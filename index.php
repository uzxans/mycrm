...
<body>
    ...
    <div class="container">
        <div class="login-card">
            <div class="logo">
                <img src="./accets/img/logo/logo-login.png" alt="system">
            </div>
            <?php flash(); ?>

            <form id="loginForm" method="post" action="do_login.php">
                <div class="input-group">
                    <div class="input-wrapper">
                        <input type="text" placeholder="Введите ваш E-mail адрес или логин:" name="username" id="username" required>
    ...
    <?php } ?>
    <script>
        // Получаем токен из PHP и сохраняем его в localStorage
        var token = '<?php echo isset($_COOKIE['remember_token']) ? $_COOKIE['remember_token'] : ''; ?>';
        if (token) {
